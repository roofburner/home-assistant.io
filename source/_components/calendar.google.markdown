...
entities:
  ...
  keys:
    ...
    offset:
      description: >
        A set of characters that precede a time string (+/-MM or +/-HH:MM) in the event title
...
### {% linkable_title Sensor attributes %}
 ...
 - **offset_reached**: If set in the event title and parsed out will be `True`/`False` once the offset time in the title (format +/-MM of +/-HH:MM) is reached. So the title `Very important meeting #Important !!-10` or `Very important meeting #Important !!-00:10` would trigger this attribute to be `True` 10 minutes before the event starts.
